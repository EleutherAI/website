...
draft: False
description: "A brief overview of EleutherAI's approach to alignment"
...
Given the current state of the AI landscape, there are a few directions that we find especially interesting. We’d love to collaborate with others to make progress on these issues.
