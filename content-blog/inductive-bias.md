...
- Within a family of architectures, changing a few properties such as the activation function (e.g. from Tanh to ReLU) or the number of layers can substantially change the training dynamics.
