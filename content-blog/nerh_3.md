...
## Implementation:
We utilized the standard trlX implementation, and after testing a wide range of hyperparameters were unable to find a run that converged to satisfactory results.
...
## Future Work:
Now that we have formulated the problem and set up our experimental environment, we hope to finetune an LLM with an iterated method like ReST.  Next, we will evaluate different variants of iteration and compare them with standard RLHF.
...
![Heatmap of reward-model fitness across five poem genres and five tones; lighter cells indicate higher fitness.](/images/blog/nerh_3/image2.png)
