...
<iframe title="Active latents and latent contexts" src="/images/blog/generating-text-using-nl-to-simulate-activations/interactive.html" style="width: 100%; height: 800px; border: none;"></iframe>
...
![Left: sensitivity declines from the most active to the least active latents, with quantile-based explanations above top-based explanations. Right: both explanation methods align with true active latents more closely than the random baseline.](/images/blog/generating-text-using-nl-to-simulate-activations/active_accuracy.png)
...
![Specificity for inactive latents and sensitivity for active latents generally increase with detection and fuzzing scores, for both top- and quantile-based explanations.](/images/blog/generating-text-using-nl-to-simulate-activations/scores_accuracy.png)
...
![Left: distributions of predicted quantiles, actual distribution quantiles, and activation bins. Right: mean actual quantile and activation bin increase with predicted quantile.](/images/blog/generating-text-using-nl-to-simulate-activations/activation_prediction.png)
